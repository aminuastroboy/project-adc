...
export default function ADCNationalCampaignWebsite() {
  const newsItems = [
    { title: "ADC National Platform Gains Momentum Across States", date: "Latest Update", text: "The campaign continues to grow its message of accountability, opportunity, and progress with stronger outreach, volunteer mobilization, and public engagement across multiple states." },
    { title: "Volunteer Registration Opens for Nationwide Mobilization", date: "Campaign News", text: "Supporters can now join the movement through the national volunteer form, helping strengthen ward, LGA, state, and national coordination." },
    { title: "Adamawa Focus Highlights Agriculture and Youth Empowerment", date: "State Update", text: "In Adamawa, the campaign is emphasizing agriculture, infrastructure, youth opportunities, education, healthcare, and practical development priorities." },
    { title: "Technology Positioned as a Support Tool for Growth", date: "Policy Brief", text: "The platform maintains its traditional core pillars while applying technology as a practical support system for governance, jobs, security, agriculture, and education." },
  ];
  ...
  return (
    <div className="min-h-screen bg-white text-slate-900">
      <header className="sticky top-0 z-20 border-b border-slate-200 bg-white/90 backdrop-blur">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4">
          ...
          <nav className="hidden gap-6 text-sm md:flex">
            ...
            <a href="#traditional" className="hover:text-green-700">Royal Courtesy</a>
      ...
      <main>
          ...
          <div className="mx-auto grid max-w-7xl gap-10 px-6 py-16 md:grid-cols-[1.2fr_0.8fr] md:py-24">
            <div className="flex flex-col justify-center">
              ...
              <div className="mt-8 flex flex-wrap gap-4">
                ...
                <a href={whatsappGroupLink} target="_blank" rel="noreferrer" className="rounded-2xl bg-green-600 px-6 py-3 font-semibold text-white">Join WhatsApp Group</a>
              </div>
            </div>
        ...
        <section id="traditional" className="bg-slate-50 py-16">
          <div className="mx-auto max-w-7xl px-6">
            <div className="text-sm font-semibold uppercase tracking-[0.2em] text-green-700">Leadership & Traditional Engagement</div>
            <h2 className="mt-3 text-3xl font-bold tracking-tight md:text-4xl">Building bridges with traditional institutions</h2>
            <p className="mt-4 max-w-3xl text-lg text-slate-600">
              Respect for traditional leadership remains central to the movement. Through courtesy visits and respectful engagement, Ahmad Rufai Abdulhamid continues to strengthen trust, unity, and collaboration across Yola South.
            </p>
            <div className="mt-10 grid gap-6 md:grid-cols-2">
              <div className="overflow-hidden rounded-[2rem] border border-slate-200 bg-white shadow-sm transition duration-300 hover:-translate-y-1 hover:shadow-xl">
                <img src="/royal1.jpg" className="h-[420px] w-full object-cover transition duration-500 hover:scale-105" alt="Courtesy visit to Hakimi Namtari" />
                <div className="p-5 text-sm leading-7 text-slate-600">
                  Courtesy visit to <strong>Hakimi Namtari (Sarki Kudu Adamawa)</strong>, reinforcing respect for traditional leadership and community unity.
                </div>
              </div>
              <div className="overflow-hidden rounded-[2rem] border border-slate-200 bg-white shadow-sm transition duration-300 hover:-translate-y-1 hover:shadow-xl">
                <img src="/royal2.jpg" className="h-[420px] w-full object-cover transition duration-500 hover:scale-105" alt="Courtesy visit to Lamido Ngurore" />
                <div className="p-5 text-sm leading-7 text-slate-600">
                  Royal courtesy visit to <strong>Lamido Ngurore</strong>, strengthening collaboration between leadership and the people of Yola South.
                </div>
              </div>
            </div>
          </div>
        ...
        <section id="event" className="bg-gradient-to-r from-emerald-50 to-orange-50 py-16">
          <div className="mx-auto max-w-7xl px-6 grid gap-10 md:grid-cols-[1.1fr_0.9fr] items-center">
            <div>
          ...
          <div className="mx-auto max-w-7xl px-6">
            ...
            <div className="mt-10 grid gap-6 md:grid-cols-2 xl:grid-cols-3">
              {[
                ...
                <img key={i} src={src} className="h-[320px] w-full rounded-2xl object-cover" alt={`Gallery ${i + 1}`} />
              ))}
            </div>
          </div>
        </section>
